const CACHE='abarrotes-pdd-v43-reimpresion';
const LOCAL=['./','./index.html','./manifest.webmanifest','./assets/styles.css?v=42','./assets/app.js?v=42','./assets/telegram-config.js','./assets/firebase-connections.js?v=32','./assets/logo.jfif','./assets/bodega-bg.webp','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
