const EMPLEADOS = [
  ...
  "PRISILA ESTEFANY AGUAYO SERNA",
  "MARIA FERNANDA ORTEGA CARDENAS",
  "ESMERALDA LIZBETH CUEVAS GAUNA",
  "LILIANA GUADALUPE PEREZ TREVIÑO",
  "ROCIO ISABEL PEREZ TREVIÑO",
  "JUAN ANGEL LOERA GUERRA",
  "GIBRAN GUADALUPE ROMAN ROSALES",
  "VANESSA LIZETH RIVERA GARCIA",
  "LIZANDRO DE JESUS LUMBRERAS SUSTAITA",
  "ROBERTO GONZALEZ DORIA",
  "CALEB HIDALGO OLVERA",
  "YADIRA ALEJANDRA AGUAYO MUÑOZ",
  "EDUARDO CUELLAR VAZQUEZ",
  "LEONARDO DANIEL CUELLAR MARTINEZ",
  "JUAN GABRIEL PEREZ CAMARRILLO",
  "DORA ALICIA CARDENAS TORRES",
  "JUAN ARTURO RODRIGUEZ GARCIA",
  "OCTAVIO CORTES ZAPATA",
  "JUAN MANUEL ROJAS SANCHEZ",
  "ERICK SAUL RAMIREZ",
  "JUAN MANUEL TAMEZ SERRATO",
  ...
  "ALAN RENE CARDONA GARCIA",
  "LINDOLFO GAUNA PEDRAZA",
  "BEATRIZ CASTILLO RAMIREZ",
  "GUADALUPE CARDENAS MORENO",
  "DULCE MARIA MENDEZ FONSECA",
  "YESMIN KAROLINA LOPEZ MANCHA",
  "YESENIA URIEGAS MENDOZA",
  "PABLO NUÑEZ PALOMINO",
  "ELOY SANCHEZ AVENDAÑO",
  "JUAN MANUEL SALDAÑA BECERRA",
  "LUIS ALBERTO PERALES AGUILAR",
  "GAEL HUMBERTO SANCHEZ (POR HORAS)",
  "JONATHAN AVENDAÑO (POR HORAS)",
  "JOSE FRANCISCO GONZALEZ GUILLEN (POR HORAS)",
  "JOSE NAPOLEON GARCIA LERMA",
  "JUAN CARLOS GONZALEZ TERRAZAS",
  "VERONICA ALEJANDRO BECERRA LERMA",
  "CLAUDIA VERONICA CUELLAR RODRIGUEZ",
  "MARTIN LEOBARDO SERNA ALEMAN",
  "ROSALVA CARRILLO SANCHEZ",
  "ROLANDO RAUL GARZA",
  "ANDREA MIRANDA MARIN CAMACHO",
  "BRENDA LIZBET COLUNGA ESPINOZA",
  "KELYLA",
  "SANDRA GUADALUPE PEREZ PATIÑO",
  "MA. ESTHER RORIGUEZ SIERRA",
  "BENIGNA ANAHI ORTEGA CARDENAS",
  "VANIA GALILEA DUARTE VILLARREAL",
  "JUAN LUIS GALLEGOS ARGUELLES",
  "ROBERTO LUNA (SUPERVISOR DE CAJAS)",
  "FERNANDO FLORES DE LA CERDA",
  "JUAN GUALBERTO SERRATO ALEJOS",
  "JENARO GAUNA CHAVEZ (PROVILEON)",
  "CINTHIA AZUCENA SANCHEZ GALINDO",
  "MARTIN LOPEZ GALINDO",
  "JESUS GUADALUPE HERNANDEZ LUNA",
  "KEVIN SAID REYES PERALES",
  "ROCIO ALMAGUER TAMEZ",
  "BLANCA ALICIA HERNANDEZ GRANADO",
  "ARMANDO AXEL ZAMBRANO SANCHEZ",
  "KENIA ESTEFANY FERNANDEZ MORENO",
  "JESUS ANTONIO ESTRADA OYERVIDES",
  "JESUS ANTONIO HERNANDEZ DEL ANGEL",
  "LUZ AURORA MUÑOZ GARCIA",
  "PABLO ANGEL RIOS HERNANDEZ",
  "ANA FERNANDA GUZMAN GARCIA",
  "FELIPE DE JESUS OYERVIDES RODRIGUEZ",
  "ANGEL ALBERTO GARZA GONZALES",
  "LUIS EDUARDO VARELA ESCOBEDO",
  "JAVIER DE OCHOA BARRERA",
  "LISANDRO OVIEDO LIMON",
  "DANIELA DEL CARMEN GAUNA MURILLO",
  "CARLOS EDUARDO DE LA GARZA JUAREZ",
  "CRISTIAN ROBERTO CABRERA VALDEZ",
  "MIGUEL ANGEL CABRERA VALDEZ",
  "SERGIO JONATHAN SANCHEZ AVENDAÑO",
  "JENNIFER LIZETH QUIROGA TURRUBIATES",
  "ADRIAN MARTINEZ LUNA",
  "JUAN FRANCISCO CERDA BARBA",
  "DIONISIO DANIEL BARAJAS PEREZ",
  "ROSALINDA RUIZ FLORES",
  "JENNY JAZMIN AGUAYO MUÑOZ",
...
async function cargarCatalogoGuiadoDesdeFirestore(origen='manual'){
  ...
  if(!d.exists){
    throw new Error('No existe /almacenes/almacen_cigarro/configuracion/catalogo_guiado');
  }
...
async function sync(){
  try{
    ...
    console.warn(e);
    guia=null;
    await delKV('guia').catch(()=>{});
    $('estadoConexion').textContent='ERROR: sin catálogo en línea';
    alert('No se pudo cargar el catálogo guiado. Revisa internet y presiona Actualizar catálogo.\n\nDetalle: '+e.message);
  }
}
...
function iniciarEscuchaConfiguracion(){
  ...
  if(!navigator.onLine){
    $('estadoConexion').textContent='ERROR: sin internet';
    return;
  }
  ...
  unsubGuiaConfig=RUTAS.CONFIG_DOC.onSnapshot({includeMetadataChanges:true},async snap=>{
    try{
      ...
      const hora=new Date().toLocaleTimeString('es-MX',{hour:'2-digit',minute:'2-digit'});
      $('estadoConexion').textContent=`Catálogo en línea ${hora}`;
...
window.addEventListener('online',()=>{
  $('estadoConexion').textContent='Internet detectado. Actualizando catálogo...';
  cargarCatalogoGuiadoDesdeFirestore('online')
    .then(()=>iniciarEscuchaConfiguracion())
    .catch(e=>{
      console.warn(e);
      $('estadoConexion').textContent='ERROR: no actualizó catálogo';
    });
});
