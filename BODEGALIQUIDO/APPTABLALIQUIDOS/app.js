...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // Al terminar la carga entra directamente a MENUINICIO.
  // En celular evita pasar primero por el menu de tres puntos.
  // En PC conserva el mismo comportamiento de arranque.
