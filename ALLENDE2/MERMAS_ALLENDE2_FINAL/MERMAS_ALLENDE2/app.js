...
async function subirDocumentoFirebase(documento){
  ...
  await setDoc(
    docRef(db, APP_CONFIG.COLECCION_TIENDAS, APP_CONFIG.TIENDA_ALLENDE 2, APP_CONFIG.SUBCOLECCION_MERMAS, documento.folio),
    docOnline,
    { merge:true }
  );
}
...
function construirDocumentoMerma(){
  ...
  return {
    ...
    allende2Coleccion:APP_CONFIG.TIENDA_ALLENDE 2,
