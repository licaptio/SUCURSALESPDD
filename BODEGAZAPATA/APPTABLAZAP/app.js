...
function aplicarMovimientoInventario(existenciaActual, mov) {
  ...
  if (mov.tipo === "AJUINV") {
    return Number(mov.existencia_fisica || 0);
  }
...
function construirPivot(
  ...
  // IMPORTANTE:
  // El inventario inicial de la semana NO se calcula sumando diferencias de ajustes.
  // Se reconstruye cronológicamente desde el inventario base hasta el sábado anterior.
  // Cuando aparece un AJUINV, la existencia se sustituye por la existencia física.
  // Así la existencia final de la semana 26 se convierte en INVINI de la semana 27.
