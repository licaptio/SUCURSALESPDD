...
// V17: RAWBT + sincronizacion en segundo plano. El arranque ya NO depende de Firebase/CDN. Todo lo remoto se carga
...
function printRawBtSalida(salida){
  try{
    ...
    const a=document.createElement('a');a.href='rawbt:base64,'+payload;a.style.display='none';document.body.appendChild(a);a.click();a.remove();
    return true;
  }catch(e){console.error('[RAWBT]',e);return false}
}
...
// V16: recuperar red no fuerza refresco ni cambia de pantalla automáticamente.
