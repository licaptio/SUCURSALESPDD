const CACHE='abarrotes-pdd-v26';
const LOCAL=['./','./index.html','./manifest.webmanifest','./assets/styles.css?v=26','./assets/app.js?v=26','./assets/telegram-config.js','./assets/logo.jfif','./assets/bodega-bg.webp','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
