...
export const APP_CONFIG = Object.freeze({
  nombre: "RUTA VENTA 2",
  tiendaDocumento: "RUTA2",
  almacenId: "Almacen_Ruta_2",
  rutaIdVentas: "Almacen_Ruta_2",
  fechaBaseInventario: "2026-05-14",
  fechaInicioMinima: "2026-05-14",
  corteInventario: "2026-05-14 23:59:59",
  colecciones: Object.freeze({
    inventarios: ["TIENDAS", "RUTA2", "INVENTARIOS"],
    entradas: ["almacenes", "Almacen_Ruta_2", "entradas"],
    ventas: ["ventas_rutav2"],
    ajustes: ["TIENDAS", "RUTA2", "AJUSTE"],
    conteos: ["TIENDAS", "RUTA2", "CONTEO_DIARIO"]
  }),
  cache: Object.freeze({
    dbName: "PROVSOFT_RUTA_VENTA_2",
    version: 1,
    store: "cache_app",
    ttlHoras: 8
  })
