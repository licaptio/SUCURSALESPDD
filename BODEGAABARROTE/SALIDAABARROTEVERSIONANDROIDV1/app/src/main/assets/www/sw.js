const CACHE='salida-pdd-v57';
const LOCAL=['./','./index.html','./manifest.webmanifest','./assets/styles.css?v=42','./assets/app.js?v=56','./assets/telegram-config.js','./assets/firebase-connections.js?v=32','./assets/logo.jfif','./assets/bodega-bg.webp','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
