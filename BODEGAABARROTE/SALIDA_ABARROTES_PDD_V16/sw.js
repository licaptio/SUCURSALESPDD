const CACHE='abarrotes-pdd-v20';
const LOCAL=['./','./index.html','./manifest.webmanifest','./assets/styles.css?v=20','./assets/styles.css','./assets/app.js?v=20','./assets/app.js','./assets/telegram-config.js','./assets/logo.jfif','./assets/bodega-bg.webp','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
