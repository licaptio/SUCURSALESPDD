PROVSOFT SALIDA PDD - HISTORIAL UNIFICADO V44 A V57
====================================================

Este archivo consolida los README técnicos incluidos en las versiones V44, V46, V48, V49, V51, V52, V53, V54, V55, V56 y V57.
...
README V57
============================================================
PROVSOFT SALIDA PDD V57 - SPP ESTABLE PRINTER001

- Mantiene intacto el ticket V56 y el modo gráfico GS v 0 validado físicamente.
- La impresión real prioriza exclusivamente SPP_INSECURE, método ya confirmado con Printer001.
- Si el primer SPP_INSECURE falla, espera 1.4 s y repite el mismo método.
- SPP_SECURE queda únicamente como último recurso estándar.
- Se eliminaron de la ruta de impresión real los barridos RFCOMM por canales 1-3.
- El objetivo es evitar esperas largas y conexiones residuales durante una salida real.
- Build visible: SALIDA PDD · V57 ANDROID.


============================================================
V58 - CIERRE EXPLICITO EN SELECTOR BLUETOOTH
============================================================
- Se agregó botón visible “✕ CERRAR” al selector nativo de impresoras Bluetooth.
- Permite abandonar el selector sin elegir o cambiar impresora.
- Se conserva sin cambios la lógica estable SPP y el ticket gráfico de V57.


============================================================
V60 - CAMARA DIRECTA Y FIJA PARA ENTRADAS
============================================================
- El botón TOMAR FOTO ya no abre un selector combinado Galería/Cámara.
- Se eliminó ACTION_CHOOSER del flujo de captura de fotografías de entrada.
- ACTION_IMAGE_CAPTURE abre directamente una aplicación de cámara.
- La app prioriza y fija una cámara del sistema/OEM instalada para evitar que Android
  pregunte repetidamente con qué aplicación abrir la cámara.
- El input HTML queda marcado con capture=environment para solicitar cámara trasera.
- Después de cada fotografía el formulario queda listo para agregar otra foto.
- Se conserva intacta la lógica de compresión, previsualización y guardado de entradas.
