PROVSOFT · RUTA VENTA 2 · NUEVA VERSIÓN
...
RUTAS FIRESTORE
- /TIENDAS/RUTA2/INVENTARIOS
- /almacenes/Almacen_Ruta_2/entradas
- /ventas_rutav2 (filtro rutaId = Almacen_Ruta_2)
- /TIENDAS/RUTA2/AJUSTE
- /TIENDAS/RUTA2/CONTEO_DIARIO
...
- Listas reutilizables de conteo diario.
- Guardado, edición y eliminación de listas en Firebase.
- Generación posterior de cada lista en PDF.
- Exportación Excel.
- Impresión / PDF.
...
- Título simplificado a INVENTARIO RUTA VENTA 2.
