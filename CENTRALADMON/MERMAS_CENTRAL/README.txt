...
ACTUALIZACION UI POS 24-08-2026
- Flujo simplificado: Datos -> Captura POS -> Finalizar.
- Buscador arriba y carrito completo debajo.
- Cada partida puede Modificarse o Eliminarse desde el carrito.
- La firma ya no es un paso independiente: se solicita justo antes de guardar.
- Se conserva catálogo diario automático, IndexedDB, trabajo offline y cola Firebase pendiente.
