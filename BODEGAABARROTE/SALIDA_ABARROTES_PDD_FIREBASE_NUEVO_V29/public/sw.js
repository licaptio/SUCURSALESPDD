const CACHE='abarrotes-pdd-v27';
const LOCAL=['./','./index.html','./manifest.webmanifest','./assets/styles.css?v=27','./assets/app.js?v=27','./assets/telegram-config.js','./assets/logo.jfif','./assets/bodega-bg.webp','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
