const CACHE='abarrotes-pdd-v16';
const LOCAL=['./','./index.html','./manifest.webmanifest','./assets/styles.css?v=16','./assets/styles.css','./assets/app.js?v=16','./assets/app.js','./assets/telegram-config.js','./assets/logo.jfif','./assets/bodega-bg.webp','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
