const DB_NAME = "PROVSOFT_INVENTARIO_MONTEMORELOS_DB";
const DB_VERSION = 3;
...
function abrirDB() {
  return new Promise((resolve, reject) => {
    ...
    req.onupgradeneeded = () => {
      ...
      // Limpia almacenes heredados que Montemorelos ya no utiliza.
      ["transferencias", "intercambios", "intercambios_salida_allende2"].forEach(store => {
        if (db.objectStoreNames.contains(store)) {
