const CACHE='abarrotes-pdd-v35-menu-operativo';
const LOCAL=['./','./index.html','./manifest.webmanifest','./assets/styles.css?v=35','./assets/app.js?v=35','./assets/telegram-config.js','./assets/firebase-connections.js?v=32','./assets/logo.jfif','./assets/bodega-bg.webp','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
