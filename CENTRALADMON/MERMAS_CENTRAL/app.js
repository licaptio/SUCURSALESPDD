...
function pintarRevision(){
  ...
  document.getElementById("resumenRevision").innerHTML = `
    <p><strong>Tienda reporta:</strong> ${APP_CONFIG.TIENDA_CENTRAL}</p>
...
function pintarFinal(){
  ...
  document.getElementById("resumenFinal").innerHTML = `
    <p><strong>Documento CENTRAL listo para generar.</strong></p>
    <p><strong>Ruta:</strong> /TIENDAS/CENTRAL/MERMAS/${document.getElementById("folio").value}</p>
    <p><strong>Destino operativo:</strong> ${APP_CONFIG.DESTINO_OPERATIVO}</p>
    <p><strong>Folio:</strong> ${document.getElementById("folio").value}</p>
