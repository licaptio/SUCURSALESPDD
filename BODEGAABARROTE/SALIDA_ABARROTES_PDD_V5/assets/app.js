...
async function saveEntry(){
  ...
  try{
    ...
    await setDoc(doc(db,...R.entradasFoto,entryId),{
      entradaId,usuario:S.user?.usuario||'JUAN',usuarioId:S.user?.id||FIXED_USER_DOC,nombreUsuario:S.user?.nombre||'',
    ...
    console.error('[ENTRADA FOTO]',e);$('entryStatus').textContent='No se pudo completar la entrada. Revisa conexión/permisos e intenta nuevamente.';$('entryStatus').classList.add('error');
...
$('modeEntrada').onclick=enterEntrada;
$('modeSalida').onclick=enterSalida;
